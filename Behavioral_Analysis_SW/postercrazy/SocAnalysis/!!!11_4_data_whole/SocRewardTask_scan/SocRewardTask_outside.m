...
[imagename, ~, alpha] = imread(fullfile(maindir,'imgs','cue1.png'));
imagename(:,:,4) = alpha(:,:);
scan1_texture = Screen('MakeTexture', mywindow, imagename);
[imagename, ~, alpha] = imread(fullfile(maindir,'imgs','cue5.png'));
imagename(:,:,4) = alpha(:,:);
...
longest_msg = 'Each letter will yield 1 to 100 points, but the value of the letter changes over time.';
...
Screen('TextStyle', mywindow, 0);
Screen('DrawText', mywindow, 'On each trial, you will see two Greek letters (alpha and beta).', (centerhoriz-(normBoundsRect(3)/2)), (centervert-(35*scale_res(2))), black);
Screen('DrawText', mywindow, longest_msg, (centerhoriz-(normBoundsRect(3)/2)), centervert, black);
Screen('DrawText', mywindow, 'Keep track of the value of each letter and choose accordingly.', (centerhoriz-(normBoundsRect(3)/2)), (centervert+(35*scale_res(2))), black);
Screen('DrawText', mywindow, 'Press the spacebar to start the task.', (centerhoriz-(normBoundsRect(3)/2)), (centervert+(70*scale_res(2))), black);
